<! Doctype html>  
    <html lang="en">  
    <head>  
    <title>CCD Deposit Register</title>
...
div {
    ...
    line-height: 0px !important;">  <br />Update the record in CCD Deposit Register</h1>  
    <form method="post" action="depositupd.php" style="
	background:#f7f7f7;
	width: 700px;
	...
	margin-top:10px;">    
      ...
      <br> <br>  
      <label> Challan no: &nbsp;&nbsp;</label> <input type="number" name="chalon_no" style="width: 150px" autocomplete="off" >  
       
      <br> <br>  
      <label> Amount: &nbsp;&nbsp;</label><input type="float" name="amount" style="width: 150px" autocomplete="off" >  
        
      <br> <br>  
      <label style="width:250px;margin-left:-150px;"> Reward or Closed: &nbsp;&nbsp;</label> 

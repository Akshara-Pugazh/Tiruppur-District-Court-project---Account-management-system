...
#form1 {
  ...
  text-align: center;
    ...
    line-height: 0px !important;">  <br />Update records in Sub Court Budget Allotment Register</h1>  
    <form method="post" action="scupd.php" style="
	background:#f7f7f7;
	width: 900px;
	...
	<label style="width:300px;margin-left:-170px;"> Sanction id:  &nbsp;&nbsp;</label> <input type="number" name="sc_id" style="width:150px;" autocomplete="off" >  
     <br> <br>

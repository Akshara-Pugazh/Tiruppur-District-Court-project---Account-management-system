...
<body>
    ...
    echo nl2br("\n$sancamtErr\n $sancdateErr\n $sancorderErr\n $sancborErr\n");
		...
		$sql = "UPDATE load_sanction SET sanction_amount = '$sanction_amount',sanction_date = '$sanction_date',sanction_borrower = '$sanction_borrower' WHERE sanction_order = '$sanction_order'";
